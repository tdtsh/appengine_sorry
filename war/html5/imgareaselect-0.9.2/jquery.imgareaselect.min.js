(function($) {
	...
	$.imgAreaSelect=function(img,options) {
		...
		},docElem=document.documentElement,$p,d,i,o,w,h,adjusted;
...
if(y<=resizeMargin)resize='n';
else if(y>=selection.height-resizeMargin)resize='s';
if(x<=resizeMargin)resize+='w';
else if(x>=selection.width-resizeMargin)resize+='e'
}
...
break;
case 38:doMove(x1,max(y1-d,top));
break;
case 39:doMove(x1+min(d,imgWidth-selX(x2)),y1);
break;
case 40:doMove(x1,y1+min(d,imgHeight-selY(y2)));
break;
default:return
}
